# figure_8.r
## figure showing trend of area contributions with marginal runoff increase
## Eric Barefoot
# Feb 2019
...
ggsave(filename = 'figure_8_draft.pdf', plot = combined, path = here('figures','outputs'), width = 7, height = 4, units = 'in')
